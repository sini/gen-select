{
  ...
  outputs =
    ...
    let
      ...
      tests = lib.foldl' (
        acc: file: acc // (import ./tests/${file} { inherit lib selectLib genAlgebra; })
      ) { } testFiles;
    in
    flake-parts.lib.mkFlake { inherit inputs; } {
      ...
      perSystem =
        ...
        in
        {
          ...
          checks.default = pkgs.runCommand "gen-select-tests" { } ''
          ...
          devshells.default = {
            ...
            commands = [
              ...
              {
                name = "repl";
                help = "Interactive REPL with gen-select loaded";
                command = ''
